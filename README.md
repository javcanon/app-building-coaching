...
A shared space for resources to help a friend go from zero software background to building
their first app with an AI coding tool (like Claude Code). Start with the fundamentals, add
more as we go.
